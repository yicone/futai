...
namespace FuTai.Component
{
    ...
    partial void InsertRegisterCode(RegisterCode instance);
    partial void UpdateRegisterCode(RegisterCode instance);
    partial void DeleteRegisterCode(RegisterCode instance);
    ...
    partial void DeleteUser(User instance);
		...
		public FuTaiDBDataContext() : 
				base(global::FuTai.Component.Properties.Settings.Default.FuTaiConnectionString7, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<RegisterCode> RegisterCode
		{
			get
			{
				return this.GetTable<RegisterCode>();
			}
		}
	...
	[Table(Name="dbo.RegisterCode")]
	public partial class RegisterCode : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private int _RegisterCodeId;
		
		private int _UserId;
		
		private string _RegisterCode1;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnRegisterCodeIdChanging(int value);
    partial void OnRegisterCodeIdChanged();
    partial void OnUserIdChanging(int value);
    partial void OnUserIdChanged();
    partial void OnRegisterCode1Changing(string value);
    partial void OnRegisterCode1Changed();
    partial void OnCreateDateChanging(System.DateTime value);
    partial void OnCreateDateChanged();
    partial void OnHasActivedChanging(bool value);
    partial void OnHasActivedChanged();
    #endregion
		...
		[Column(Storage="_RegisterCodeId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int RegisterCodeId
		{
			get
			{
				return this._RegisterCodeId;
			}
			set
			{
				if ((this._RegisterCodeId != value))
				{
					this.OnRegisterCodeIdChanging(value);
					this.SendPropertyChanging();
					this._RegisterCodeId = value;
					this.SendPropertyChanged("RegisterCodeId");
					this.OnRegisterCodeIdChanged();
				}
			}
		}
		...
		[Column(Name="RegisterCode", Storage="_RegisterCode1", DbType="Char(16) NOT NULL", CanBeNull=false)]
		public string RegisterCode1
		{
			get
			{
				return this._RegisterCode1;
			}
			set
			{
				if ((this._RegisterCode1 != value))
				{
					this.OnRegisterCode1Changing(value);
					this.SendPropertyChanging();
					this._RegisterCode1 = value;
					this.SendPropertyChanged("RegisterCode1");
					this.OnRegisterCode1Changed();
				}
			}
		}
		...
		[Column(Storage="_HasActived", DbType="Bit NOT NULL")]
		public bool HasActived
		{
			get
			{
				return this._HasActived;
			}
			set
			{
				if ((this._HasActived != value))
				{
					this.OnHasActivedChanging(value);
					this.SendPropertyChanging();
					this._HasActived = value;
					this.SendPropertyChanged("HasActived");
					this.OnHasActivedChanged();
				}
			}
		}
	...
	public partial class User : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<bool> _HasActivated;
    ...
    partial void OnLoginDateChanging(System.DateTime value);
    partial void OnLoginDateChanged();
    partial void OnHasActivatedChanging(System.Nullable<bool> value);
    partial void OnHasActivatedChanged();
    #endregion
		...
		[Column(Storage="_LoginDate", DbType="DateTime NOT NULL")]
		public System.DateTime LoginDate
		{
			get
			{
		...
		[Column(Storage="_HasActivated", DbType="Bit")]
		public System.Nullable<bool> HasActivated
		{
			get
			{
				return this._HasActivated;
			}
			set
			{
				if ((this._HasActivated != value))
				{
					this.OnHasActivatedChanging(value);
					this.SendPropertyChanging();
					this._HasActivated = value;
					this.SendPropertyChanged("HasActivated");
					this.OnHasActivatedChanged();
				}
			}
		}
