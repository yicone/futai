...
namespace FuTai.Component
{
    ...
    partial void OnFluorescenceChanged();
		...
		[Association(Name="Diamond_Product", Storage="_Product", OtherKey="ProductId")]
    ...
    partial void OnType2Changed();
		...
		[Association(Name="DiamondOrnament_Product", Storage="_Product", OtherKey="ProductId")]
		public EntitySet<Product> Product
		{
			get
			{
    ...
    partial void OnotherDiamondCaratChanged();
		...
		[Association(Name="DiamondRing_Product", Storage="_Product", OtherKey="ProductId")]
		public EntitySet<Product> Product
		{
			get
			{
    ...
    partial void OnType2Changed();
		...
		[Association(Name="GoldOrnament_Product", Storage="_Product", OtherKey="ProductId")]
		public EntitySet<Product> Product
		{
			get
			{
    ...
    partial void OnType1Changed();
		...
		[Association(Name="Jewel_Product", Storage="_Product", OtherKey="ProductId")]
		public EntitySet<Product> Product
		{
			get
			{
    ...
    partial void OnCraftChanged();
		...
		[Association(Name="RingBracket_Product", Storage="_Product", OtherKey="ProductId")]
		public EntitySet<Product> Product
		{
			get
			{
