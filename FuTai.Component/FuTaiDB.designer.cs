...
namespace FuTai.Component
{
    ...
    partial void OnFluorescenceChanged();
		...
		[Association(Name="Diamond_Product", Storage="_Product", ThisKey="DiamondID", OtherKey="ProductId")]
    ...
    partial void OnType2Changed();
		...
		[Association(Name="DiamondOrnament_Product", Storage="_Product", ThisKey="DiamondOrnamentId", OtherKey="ProductId")]
		public EntitySet<Product> Product
		{
			get
			{
    ...
    partial void OnotherDiamondCaratChanged();
		...
		[Association(Name="DiamondRing_Product", Storage="_Product", ThisKey="DiamondRingId", OtherKey="ProductId")]
		public EntitySet<Product> Product
		{
			get
			{
    ...
    partial void OnGoldpriceChanging(System.Nullable<decimal> value);
    partial void OnGoldpriceChanged();
    partial void OngongfeiChanging(System.Nullable<decimal> value);
    ...
    partial void OnType2Changed();
		...
		[Association(Name="GoldOrnament_Product", Storage="_Product", ThisKey="GoldOrnamentId", OtherKey="ProductId")]
		public EntitySet<Product> Product
		{
			get
			{
    ...
    partial void OnType1Changed();
		...
		[Association(Name="Jewel_Product", Storage="_Product", ThisKey="JewelId", OtherKey="ProductId")]
		public EntitySet<Product> Product
		{
			get
			{
    ...
    partial void OnDiscountTypeChanged();
		...
		[Association(Name="Diamond_Product", Storage="_Diamond", ThisKey="ProductId", OtherKey="DiamondID", IsForeignKey=true)]
		...
		[Association(Name="DiamondOrnament_Product", Storage="_DiamondOrnament", ThisKey="ProductId", OtherKey="DiamondOrnamentId", IsForeignKey=true)]
		...
		[Association(Name="DiamondRing_Product", Storage="_DiamondRing", ThisKey="ProductId", OtherKey="DiamondRingId", IsForeignKey=true)]
		...
		[Association(Name="GoldOrnament_Product", Storage="_GoldOrnament", ThisKey="ProductId", OtherKey="GoldOrnamentId", IsForeignKey=true)]
		...
		[Association(Name="Jewel_Product", Storage="_Jewel", ThisKey="ProductId", OtherKey="JewelId", IsForeignKey=true)]
		public Jewel Jewel
		{
			get
			{
		...
		[Association(Name="RingBracket_Product", Storage="_RingBracket", ThisKey="ProductId", OtherKey="BracketId", IsForeignKey=true)]
    ...
    partial void OnCraftChanged();
		...
		[Association(Name="RingBracket_Product", Storage="_Product", ThisKey="BracketId", OtherKey="ProductId")]
		public EntitySet<Product> Product
		{
			get
			{
