...
namespace FuTai.Component
{
    ...
    partial void OnFluorescenceChanged();
		...
		[Association(Name="Diamond_Product", Storage="_Products", ThisKey="DiamondID", OtherKey="ProductId")]
    ...
    partial void OnType2Changed();
		...
		[Association(Name="DiamondOrnament_Product", Storage="_Products", ThisKey="DiamondOrnamentId", OtherKey="ProductId")]
		public EntitySet<Product> Products
		{
			get
			{
    ...
    partial void OnotherDiamondCaratChanged();
		...
		[Association(Name="DiamondRing_Product", Storage="_Products", ThisKey="DiamondRingId", OtherKey="ProductId")]
		public EntitySet<Product> Products
		{
			get
			{
    ...
    partial void OnType2Changed();
		...
		[Association(Name="GoldOrnament_Product", Storage="_Products", ThisKey="GoldOrnamentId", OtherKey="ProductId")]
		public EntitySet<Product> Products
		{
			get
			{
    ...
    partial void OnType1Changed();
		...
		[Association(Name="Jewel_Product", Storage="_Products", ThisKey="JewelId", OtherKey="ProductId")]
		public EntitySet<Product> Products
		{
			get
			{
    ...
    partial void OnType1Changed();
		...
		[Association(Name="PairRing_Product", Storage="_Products", ThisKey="PairRingId", OtherKey="ProductId")]
		public EntitySet<Product> Products
		{
			get
			{
    ...
    partial void OnSubTypeChanged();
		...
		[Association(Name="PairRing_Product", Storage="_PairRing", ThisKey="ProductId", OtherKey="PairRingId", IsForeignKey=true)]
    ...
    partial void OnCraftChanged();
		...
		[Association(Name="RingBracket_Product", Storage="_Products", ThisKey="BracketId", OtherKey="ProductId")]
		public EntitySet<Product> Products
		{
			get
			{
